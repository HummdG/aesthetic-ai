...
const CTASection = () => {
  ...
  const handleGetStartedFree = () => {
    // Go directly to analysis without requiring signup
      ...
      <section className="relative py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="bg-card/40 backdrop-blur-xl rounded-2xl lg:rounded-3xl p-6 sm:p-8 lg:p-12 xl:p-16 shadow-deep border border-primary/20 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="mb-10 space-y-6">
                  ...
                  <h2 className="font-playfair text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-6 leading-[1.25]">
                    Ready to
                ...
                {!user && (
                  <div className="text-center">
                    <p className="text-warm-gray font-inter text-sm mb-4">
                    ...
                    <Button
                      ...
                      variant="nude"
                      size="lg"
                      className="font-inter text-base px-8 py-4"
                    >
                      Sign Up for Personalized Plan
                    </Button>
                  </div>
                )}
